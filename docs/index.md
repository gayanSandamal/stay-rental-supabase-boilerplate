...
- [Facebook Post Import Deep-Dive](./deep-dive-facebook-post-import.md) — pasting a Facebook group/page post URL into the back office to create a listing: what Facebook will and will not serve, the SSRF guard on the pasted URL, why `users.wa_phone` no longer means verified, and the migration replay hazard. **Status: built 2026-09-07, both flags OFF.**
