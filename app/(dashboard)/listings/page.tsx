...
export async function generateMetadata({
  ...
  const description = parts.length > 0
    ? `Find mid-to-long-term rentals ${parts.join(' ')} in Sri Lanka — 100% free of charge. Verified contact numbers, direct contact with the owner or their agent, and no fees.`
