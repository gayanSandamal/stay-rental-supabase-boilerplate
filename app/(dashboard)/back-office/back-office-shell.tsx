...
export function getBackOfficeNavItems(showImports: boolean) {
  return [
    ...
    ...(showImports
      ? [{ href: '/back-office/imports', icon: Download, label: 'Imports' }]
      : []),
...
export default function BackOfficeShell({
  ...
  const navItems = getBackOfficeNavItems(showImports);
