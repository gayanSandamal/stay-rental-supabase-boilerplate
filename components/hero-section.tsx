    ...
    <section
      ...
      style={{
        ...
        backgroundImage: [
          ...
          'radial-gradient(circle at 80% 20%, rgba(167,139,250,0.14) 0%, transparent 50%)',
          'radial-gradient(circle at 50% 80%, rgba(56,189,248,0.10) 0%, transparent 50%)',
          'linear-gradient(135deg, #0f0c29 0%, #1a1a4e 35%, #12123a 65%, #0d1117 100%)',
        ].join(', '),
      }}
    >
      {/* Decorative orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-500/25 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-violet-500/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/2 right-1/3 w-60 h-60 bg-sky-500/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        ...
        <div className="flex justify-center mb-6">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-indigo-500/30 text-indigo-200 border border-indigo-400/40 backdrop-blur-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-6 text-lg sm:text-xl text-slate-200 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="text-amber-400 font-semibold">KYC-verified</span> landlords,{' '}
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mb-8">
          <div className="glass rounded-2xl p-1.5 shadow-2xl shadow-indigo-900/50">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          {POPULAR.map((place) => (
            <button
              key={place}
              onClick={() => go(place)}
              className="px-3.5 py-1.5 rounded-full text-xs font-medium text-slate-200 border border-white/25 hover:border-indigo-400/60 hover:text-white hover:bg-white/10 transition-all duration-200"
            >
              {place}
            </button>
          ))}
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <button
            ...
            className="btn-amber-gradient flex items-center gap-2 px-6 py-3 rounded-xl text-white font-semibold text-sm shadow-lg"
          >
