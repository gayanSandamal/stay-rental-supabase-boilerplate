      ...
      <form onSubmit={handleSubmit} className="flex-1">
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-11 pl-10 pr-4 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-600 focus:border-transparent shadow-sm"
          />
        </div>
      </form>
